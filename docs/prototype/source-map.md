...
**Prototype knowledge release:** `launch-and-sell-outline-2025-07+sigrun-feedback-2026-08-21`
...
| Workshop-group planning and joining | Beginner asks only whether a launch community exists: “yes” applies the scoped 30% default and “no” leaves group joins unestimated. Complete retains its platform choice and optional participant-supplied rate. The 30% Beginner default is not a universal group-join assumption; the outline’s 60% and 70% examples remain historical source facts | p. 22 plus Sigrun feedback, 2026-08-20 and 2026-08-21 |
...
Sigrun approved the proposed validation categories on 2026-08-16. No case sources, original inputs or approved expected outputs were supplied, so zero of five cases are currently executable. Reply `1787325821.911649` supplied Beginner defaults and question-design corrections but no historical case or approved expected outputs. The case set is tracked in [golden-cases.md](golden-cases.md), and Phase 0 remains open until the cases are run and explicitly approved.
